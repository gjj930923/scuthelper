...
<html lang="en">
  <head>
    ...
    <link href="<?php echo ($_SERVER['SCRIPT_NAME']); ?>/../Application/Home/View/Public/css/register.css" rel="stylesheet">
...
<font face="微软雅黑">
	...
	<div class="row">
      <form class="form-signin" role="form">
        ...
        <input type="input" class="form-control" placeholder="Nickname" required autofocus>
        <input type="input" class="form-control" placeholder="SCUT ID">
        <input type="password" class="form-control" placeholder="OPAC LIbrary password">
        <input type="password" class="form-control" placeholder="Sign in Password">

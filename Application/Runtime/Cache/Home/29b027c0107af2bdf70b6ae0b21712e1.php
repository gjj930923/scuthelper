...
<div class="input-group">
  <span class="input-group-addon" id="basic-addon1">商品介绍</span>
  <input type="text" class="form-control" aria-describedby="basic-addon1">
</div>
...
<div class="input-group">
  <input type="text" class="form-control" aria-describedby="basic-addon1">
  <span class="input-group-addon" id="basic-addon1">议价<input type="checkbox" aria-label="..."></span>
</div>
<select class="form-control select select-primary" data-toggle="select" id="grade">
            <option value="0" selected>成色</option>
...
<div class="input-group">
  <span class="input-group-addon" id="basic-addon1">货品来源</span>
  <input type="text" class="form-control" aria-describedby="basic-addon1">
</div>
<div class="input-group">
